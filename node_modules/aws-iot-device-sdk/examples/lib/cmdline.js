...
module.exports = function(description, args, processFunction, msg ,argumentHelp ) {
   console.log("====cmdline====");
   ...
   if (args.Protocol === 'mqtts') {
      ...
      //
      console.log("===mqtt protocal ===");
      console.log("args.privateKey = "+args.privateKey);
      console.log("args.clientCert = "+args.clientCert);
      console.log("args.caCert = ",+args.caCert);
      var privateKeyPath = "/home/ubuntu/jimmy/iotkeys/Rugby.private.key";
      var clientCertPath = "/home/ubuntu/jimmy/iotkeys/Rugby.cert.pem";
      var rootCAPath = "/home/ubuntu/jimmy/iotkeys/root-CA.crt";
